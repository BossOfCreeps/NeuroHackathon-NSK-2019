...
while True:
    ...
    #print in_string.decode('utf-8')
    #if (in_string.decode('utf-8').find(u"привет")>-1) or (in_string.decode('utf-8').find(u"Привет")>-1):
   #    print 1
        #out_string=u"Привет, привет, дорогой друг"
    #if (in_string.decode('utf-8').find(u"пока")>-1) or (in_string.decode('utf-8').find(u"Пока")>-1):
